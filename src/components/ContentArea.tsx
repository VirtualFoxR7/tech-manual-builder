      ...
      case "herramientas":
        return {
          ...
          herramientasItems: [
            ...
            { nombre: "Paño suave", imagen: "/Herramientas/toalla.jpg" },
            { nombre: "Mascarilla", imagen: "/Herramientas/Mascarilla.jpg" },
            { nombre: "Pulsera antiestática", imagen: "/Herramientas/Pulsera.jpg" },
...
"Realizar nuevas pruebas de funcionamiento: Con el equipo nuevamente armado, es hora de probar el funcionamiento, desde el arranque correcto, hasta la correcta funcionalidad de la imagen en pantalla y los dispositivos de entrada.",
  ...
  if (activeSection === "glosario") {
    return (
      <main className={asSection ? "p-8 bg-background scroll-mt-24" : "mt-20 p-8 bg-background min-h-screen"} id={asSection ? activeSection : undefined}>
